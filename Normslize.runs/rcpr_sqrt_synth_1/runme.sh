...
HD_PWD='/home/alhua/VivadoProject/Normslize/Normslize.runs/rcpr_sqrt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rcpr_sqrt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rcpr_sqrt.tcl
