...
HD_PWD='/home/alhua/VivadoProject/Normslize/Normslize.runs/LayerNorm_cal_norm_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LayerNorm_cal_norm_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LayerNorm_cal_norm_top_0_0.tcl
