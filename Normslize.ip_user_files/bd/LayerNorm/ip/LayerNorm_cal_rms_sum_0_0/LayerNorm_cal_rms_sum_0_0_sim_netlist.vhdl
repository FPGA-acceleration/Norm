...
--               /home/alhua/VivadoProject/Normslize/Normslize.gen/sources_1/bd/LayerNorm/ip/LayerNorm_cal_rms_sum_0_0/LayerNorm_cal_rms_sum_0_0_sim_netlist.vhdl
...
entity LayerNorm_cal_rms_sum_0_0_gen_tlast is
  port (
  ...
  attribute ORIG_REF_NAME of LayerNorm_cal_rms_sum_0_0_gen_tlast : entity is "gen_tlast";
end LayerNorm_cal_rms_sum_0_0_gen_tlast;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0_gen_tlast is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_rms_sum_0_0_sum_keep is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_rms_sum_0_0_sum_keep : entity is "sum_keep";
end LayerNorm_cal_rms_sum_0_0_sum_keep;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0_sum_keep is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_rms_sum_0_0_add8 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_rms_sum_0_0_add8 : entity is "add8";
end LayerNorm_cal_rms_sum_0_0_add8;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0_add8 is
  component LayerNorm_cal_rms_sum_0_0_floating_point_1 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component LayerNorm_cal_rms_sum_0_0_floating_point_1;
  component LayerNorm_cal_rms_sum_0_0_floating_point_1_HD2 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    m_axis_result_tready : in STD_LOGIC;
  ...
  end component LayerNorm_cal_rms_sum_0_0_floating_point_1_HD2;
...
begin
\STAGE1[0].add_s1\: component LayerNorm_cal_rms_sum_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE1[1].add_s1\: component LayerNorm_cal_rms_sum_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE1[2].add_s1\: component LayerNorm_cal_rms_sum_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE1[3].add_s1\: component LayerNorm_cal_rms_sum_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE2[0].add_s2\: component LayerNorm_cal_rms_sum_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\STAGE2[1].add_s2\: component LayerNorm_cal_rms_sum_0_0_floating_point_1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
add_s3: component LayerNorm_cal_rms_sum_0_0_floating_point_1_HD2
     port map (
      aclk => aclk,
      aresetn => arstn,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_rms_sum_0_0_parallel_squarev2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_rms_sum_0_0_parallel_squarev2 : entity is "parallel_squarev2";
end LayerNorm_cal_rms_sum_0_0_parallel_squarev2;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0_parallel_squarev2 is
  component LayerNorm_cal_rms_sum_0_0_bf_mul is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_a_tvalid : in STD_LOGIC;
  ...
  end component LayerNorm_cal_rms_sum_0_0_bf_mul;
  component LayerNorm_cal_rms_sum_0_0_bf_mul_HD1 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    m_axis_result_tready : in STD_LOGIC;
  ...
  end component LayerNorm_cal_rms_sum_0_0_bf_mul_HD1;
...
\square[0].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[1].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[2].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[3].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[4].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[5].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[6].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\square[7].square\: component LayerNorm_cal_rms_sum_0_0_bf_mul_HD1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_rms_sum_0_0_squaresum_acc is
  port (
    m_axis_result_tvalid : out STD_LOGIC;
    m_axis_result_tdata : out STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_rms_sum_0_0_squaresum_acc : entity is "squaresum_acc";
end LayerNorm_cal_rms_sum_0_0_squaresum_acc;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0_squaresum_acc is
  component LayerNorm_cal_rms_sum_0_0_floating_point_2 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_a_tvalid : in STD_LOGIC;
  ...
  end component LayerNorm_cal_rms_sum_0_0_floating_point_2;
...
acc_u1: component LayerNorm_cal_rms_sum_0_0_floating_point_2
     port map (
      aclk => aclk,
      aresetn => arstn,
...
add8_u1: entity work.LayerNorm_cal_rms_sum_0_0_add8
     port map (
...
gen_last_u1: entity work.LayerNorm_cal_rms_sum_0_0_gen_tlast
     port map (
      D(15 downto 0) => tdata_add2last(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_rms_sum_0_0_cal_rms_sum is
  port (
    aclk : in STD_LOGIC;
    arstn : in STD_LOGIC;
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_rms_sum_0_0_cal_rms_sum : entity is "cal_rms_sum";
end LayerNorm_cal_rms_sum_0_0_cal_rms_sum;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0_cal_rms_sum is
  component LayerNorm_cal_rms_sum_0_0_bf_mul is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
...
begin
keep: entity work.LayerNorm_cal_rms_sum_0_0_sum_keep
     port map (
...
u_accumulatorv2: entity work.LayerNorm_cal_rms_sum_0_0_squaresum_acc
     port map (
      E(0) => u_accumulatorv2_n_17,
...
u_ps: entity work.LayerNorm_cal_rms_sum_0_0_parallel_squarev2
     port map (
      M_AXIS_TDATA(127 downto 0) => mean_data(127 downto 0),
...
variance: component LayerNorm_cal_rms_sum_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
      m_axis_result_tdata(15 downto 0) => M_AXIS_TDATA(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_rms_sum_0_0 is
  port (
    aclk : in STD_LOGIC;
    arstn : in STD_LOGIC;
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  attribute NotValidForBitStream of LayerNorm_cal_rms_sum_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of LayerNorm_cal_rms_sum_0_0 : entity is "LayerNorm_cal_rms_sum_0_0,cal_rms_sum,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of LayerNorm_cal_rms_sum_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of LayerNorm_cal_rms_sum_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of LayerNorm_cal_rms_sum_0_0 : entity is "cal_rms_sum,Vivado 2024.2";
end LayerNorm_cal_rms_sum_0_0;

architecture STRUCTURE of LayerNorm_cal_rms_sum_0_0 is
...
begin
inst: entity work.LayerNorm_cal_rms_sum_0_0_cal_rms_sum
     port map (
