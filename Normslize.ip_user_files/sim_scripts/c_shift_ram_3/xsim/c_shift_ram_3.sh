...
#
# Script generated by Vivado on Fri Oct 31 20:46:42 CST 2025
...
simulate()
{
  xsim c_shift_ram_3 -key {Behavioral:sim_1:Functional:c_shift_ram_3} -tclbatch cmd.tcl -protoinst "protoinst_files/LayerNorm.protoinst" -log simulate.log
}
