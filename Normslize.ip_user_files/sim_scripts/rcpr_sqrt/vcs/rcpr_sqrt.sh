...
#
# Script generated by Vivado on Fri Oct 31 20:34:45 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rcpr_sqrt.sh
...
#
# Usage        : rcpr_sqrt.sh
#                rcpr_sqrt.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rcpr_sqrt.sh [-reset_run]
#                rcpr_sqrt.sh [-reset_log]
#                rcpr_sqrt.sh [-help]
#
...
#                script (type 'rcpr_sqrt.sh -help' for more information).
#
...
# script info
echo -e "rcpr_sqrt.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rcpr_sqrt.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rcpr_sqrt xil_defaultlib.glbl -o rcpr_sqrt_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rcpr_sqrt_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rcpr_sqrt_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rcpr_sqrt_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rcpr_sqrt.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rcpr_sqrt.sh [-help]\n\
Usage: rcpr_sqrt.sh [-step]\n\
Usage: rcpr_sqrt.sh [-lib_map_path]\n\
Usage: rcpr_sqrt.sh [-reset_run]\n\
Usage: rcpr_sqrt.sh [-reset_log]\n\
Usage: rcpr_sqrt.sh [-keep_index]\n\
Usage: rcpr_sqrt.sh [-noclean_files]\n\n\
