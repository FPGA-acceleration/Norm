...
#
# Script generated by Vivado on Fri Oct 31 15:57:19 CST 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L c_shift_ram_v12_0_18 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot c_shift_ram_0 xil_defaultlib.c_shift_ram_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim c_shift_ram_0 -key {Behavioral:sim_1:Functional:c_shift_ram_0} -tclbatch cmd.tcl -protoinst "protoinst_files/LayerNorm.protoinst" -log simulate.log
}
