...
-- Date        : Fri Oct 31 15:43:31 2025
-- Host        : Hua running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/alhua/VivadoProject/Normslize/Normslize.gen/sources_1/bd/LayerNorm/ip/LayerNorm_cal_norm_top_0_0/LayerNorm_cal_norm_top_0_0_sim_netlist.vhdl
-- Design      : LayerNorm_cal_norm_top_0_0
...
entity LayerNorm_cal_norm_top_0_0_bf_fifo is
  port (
  ...
  attribute ORIG_REF_NAME of LayerNorm_cal_norm_top_0_0_bf_fifo : entity is "bf_fifo";
end LayerNorm_cal_norm_top_0_0_bf_fifo;

architecture STRUCTURE of LayerNorm_cal_norm_top_0_0_bf_fifo is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_norm_top_0_0_inv_fifo is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_norm_top_0_0_inv_fifo : entity is "inv_fifo";
end LayerNorm_cal_norm_top_0_0_inv_fifo;

architecture STRUCTURE of LayerNorm_cal_norm_top_0_0_inv_fifo is
  component LayerNorm_cal_norm_top_0_0_c_shift_ram_3 is
  port (
  ...
  end component LayerNorm_cal_norm_top_0_0_c_shift_ram_3;
...
shift_ram_u: component LayerNorm_cal_norm_top_0_0_c_shift_ram_3
     port map (
      CE => shift_ram_u_i_1_n_0,
      CLK => aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_norm_top_0_0_inv_sqrt is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_norm_top_0_0_inv_sqrt : entity is "inv_sqrt";
end LayerNorm_cal_norm_top_0_0_inv_sqrt;

architecture STRUCTURE of LayerNorm_cal_norm_top_0_0_inv_sqrt is
  component LayerNorm_cal_norm_top_0_0_bf_mul is
  port (
    aclk : in STD_LOGIC;
  ...
  end component LayerNorm_cal_norm_top_0_0_bf_mul;
  component LayerNorm_cal_norm_top_0_0_bf_sub is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_a_tvalid : in STD_LOGIC;
  ...
  end component LayerNorm_cal_norm_top_0_0_bf_sub;
  component LayerNorm_cal_norm_top_0_0_bf_mul_HD1 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    m_axis_result_tready : in STD_LOGIC;
  ...
  end component LayerNorm_cal_norm_top_0_0_bf_mul_HD1;
...
u_fifo: entity work.LayerNorm_cal_norm_top_0_0_bf_fifo
     port map (
...
u_gethalf: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
u_newton1: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
u_newton2: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
u_newton3: component LayerNorm_cal_norm_top_0_0_bf_sub
     port map (
      aclk => aclk,
      aresetn => arstn,
...
u_newton4: component LayerNorm_cal_norm_top_0_0_bf_mul_HD1
     port map (
      aclk => aclk,
      aresetn => arstn,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_norm_top_0_0_inv_sqrt_top is
  port (
    Q : out STD_LOGIC_VECTOR ( 127 downto 0 );
    m_axis_result_tdata : out STD_LOGIC_VECTOR ( 15 downto 0 );
    S_AXIS_TREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_norm_top_0_0_inv_sqrt_top : entity is "inv_sqrt_top";
end LayerNorm_cal_norm_top_0_0_inv_sqrt_top;

architecture STRUCTURE of LayerNorm_cal_norm_top_0_0_inv_sqrt_top is
  component LayerNorm_cal_norm_top_0_0_bf_add is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_a_tvalid : in STD_LOGIC;
  ...
  end component LayerNorm_cal_norm_top_0_0_bf_add;
...
begin
u_epsilon: component LayerNorm_cal_norm_top_0_0_bf_add
     port map (
      aclk => aclk,
      aresetn => arstn,
...
u_inv_fifo: entity work.LayerNorm_cal_norm_top_0_0_inv_fifo
     port map (
      Q(127 downto 0) => Q(127 downto 0),
...
u_inv_sqrt: entity work.LayerNorm_cal_norm_top_0_0_inv_sqrt
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_norm_top_0_0_cal_norm_top is
  port (
    aclk : in STD_LOGIC;
    arstn : in STD_LOGIC;
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 143 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LayerNorm_cal_norm_top_0_0_cal_norm_top : entity is "cal_norm_top";
end LayerNorm_cal_norm_top_0_0_cal_norm_top;

architecture STRUCTURE of LayerNorm_cal_norm_top_0_0_cal_norm_top is
  component LayerNorm_cal_norm_top_0_0_bf_mul is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
...
\mul_invsqrtrms[0].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[1].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[2].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[3].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[4].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[5].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[6].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
\mul_invsqrtrms[7].mul\: component LayerNorm_cal_norm_top_0_0_bf_mul
     port map (
      aclk => aclk,
      aresetn => arstn,
...
u_inv_sqrt_top: entity work.LayerNorm_cal_norm_top_0_0_inv_sqrt_top
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LayerNorm_cal_norm_top_0_0 is
  port (
    aclk : in STD_LOGIC;
    arstn : in STD_LOGIC;
    S_AXIS_TDATA : in STD_LOGIC_VECTOR ( 143 downto 0 );
  ...
  attribute NotValidForBitStream of LayerNorm_cal_norm_top_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of LayerNorm_cal_norm_top_0_0 : entity is "LayerNorm_cal_norm_top_0_0,cal_norm_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of LayerNorm_cal_norm_top_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of LayerNorm_cal_norm_top_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of LayerNorm_cal_norm_top_0_0 : entity is "cal_norm_top,Vivado 2024.2";
end LayerNorm_cal_norm_top_0_0;

architecture STRUCTURE of LayerNorm_cal_norm_top_0_0 is
...
begin
inst: entity work.LayerNorm_cal_norm_top_0_0_cal_norm_top
     port map (
